...
<div class="dynamicDiv">
    ...
    <form class="form-horizontal" style="padding:10px;" enctype="multipart/form-data" action="/registrationprocess" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="email" onkeyup="checkemail()" onchange="checkemail()" id="email" class="form-control" placeholder="Enter email" name="email" required/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" id="username" onkeyup="checkusername()" onchange="checkusername()" class="form-control" minlength="5" placeholder="Enter username" name="username" required/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="password" id="confirm_password" onkeyup="passwordMatch()" onchange="passwordMatch()" class="form-control" minlength="5" placeholder="Enter password" required/>
