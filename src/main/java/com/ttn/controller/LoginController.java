...
public class LoginController {
    ...
    public ModelAndView loginProcess(@ModelAttribute User user, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response)
    {
        ...
        if(bindingResult.hasErrors())
        {
            ...
            else
            {
                ...
                m.addObject("loginErrorMessage","Invalid UserName Or Password");
                modelAndView=m;
            }
        }
        return modelAndView;
    ...
    public ModelAndView registrationProcess(@ModelAttribute User user,@RequestParam("fileupload") MultipartFile fileUpload,HttpSession session,HttpServletRequest request)throws Exception {
        ModelAndView mav = null;
        int flag = 0;
        if (!fileUpload.isEmpty()) {
            ...
            File file = new File("/home/ankur/Desktop/NewLinkSharing/src/main/webapp/resources/defaultpic.png");
    ...
    public void updatePassword(String useremailid,String password,String verificationcode,HttpServletResponse response,HttpServletRequest request) throws IOException {
