            ...
            , HttpServletResponse response, @RequestParam("file") MultipartFile file, HttpServletRequest request)
    {
        ...
        if (!file.isEmpty()) {
            try {
                ...
                File serverFile = new File("/home/ankur/Desktop/NewLinkSharing/src/main/webapp/resources/UserAssets/" +randomnumber+ file.getOriginalFilename());
                ...
                createDocumentResource.setFilepath("/home/ankur/Desktop/NewLinkSharing/src/main/webapp/resources/UserAssets/" +randomnumber+ file.getOriginalFilename());
